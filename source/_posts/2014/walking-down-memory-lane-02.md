...
thumbnail: /images/walking-down-memory-lane-02-000.png
---

As per our previous [article](/2014/09/21/2014/walking-down-memory-lane-01) we identified that we need a way to serialize objects into memory in a very efficient manner. To recap here is a picture showing the steps we need to remove when sending/receiving objects over the network.


{%img /images/walking-down-memory-lane-02-000.png 300 %}
...
{%img /images/walking-down-memory-lane-02-001.png  %}
...
{%img /images/walking-down-memory-lane-02-002.png [40%] height=100% %}
